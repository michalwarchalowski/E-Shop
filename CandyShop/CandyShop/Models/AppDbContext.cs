       ...
       public  DbSet<Candy> Candies { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\chocolateCandy-small.jpg",
                IsOnStock = true,
                IsOnSale = false
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\chocolateCandy2-small.jpg",
                IsOnStock = true,
                IsOnSale = true
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\chocolateCandy3-small.jpg",
                IsOnStock = true,
                IsOnSale = false
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\fruitCandy-small.jpg",
                IsOnStock = true,
                IsOnSale = false
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\fruitCandy2-small.jpg",
                IsOnStock = true,
                IsOnSale = true
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\fruitCandy3-small.jpg",
                IsOnStock = true,
                IsOnSale = true
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\gummyCandy-small.jpg",
                IsOnStock = true,
                IsOnSale = true
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\gummyCandy2-small.jpg",
                IsOnStock = true,
                IsOnSale = false
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\gummyCandy3-small.jpg",
                IsOnStock = true,
                IsOnSale = false
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\halloweenCandy-small.jpg",
                IsOnStock = true,
                IsOnSale = true
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\halloweenCandy2-small.jpg",
                IsOnStock = true,
                IsOnSale = true
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\halloweenCandy3-small.jpg",
                IsOnStock = true,
                IsOnSale = true
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\hardCandy-small.jpg",
                IsOnStock = true,
                IsOnSale = false
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\hardCandy2-small.jpg",
                IsOnStock = true,
                IsOnSale = true
            });
            modelBuilder.Entity<Candy>().HasData(new Candy
            {
                ...
                ImageThumnailUrl = "\\Images\\thumbnails\\hardCandy3-small.jpg",
                IsOnStock = true,
                IsOnSale = false
            });
        }
